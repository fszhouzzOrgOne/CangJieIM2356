...
public class Cj2356InputMethodService extends InputMethodService {
    ...
    public void onCreate() {
        ...
        try {
            ...
            Toast.makeText(this, "初始化輸入法失敗" + e.getMessage(), Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    public View onCreateInputView() {
        ...
        try {
            ...
            Toast.makeText(this, "候選欄初始化失敗：" + e.getMessage(),
        ...
        try {
            ...
            Toast.makeText(this, "主鍵盤初始化失敗：" + e.getMessage(),
                    Toast.LENGTH_LONG).show();
        }
        // 第一個輸入法
        try {
            ...
            Toast.makeText(this, "輸入法初始化失敗：" + e.getMessage(),
                    Toast.LENGTH_LONG).show();
        }
        // 數字鍵盤
        try {
            ...
            Toast.makeText(this, "數字鍵盤初始化失敗：" + e.getMessage(),
                    Toast.LENGTH_LONG).show();
        }
        // 符號鍵盤
        try {
            ...
            Toast.makeText(this, "符號鍵盤初始化失敗：" + e.getMessage(),
                    Toast.LENGTH_LONG).show();
        }
        try {
            // 選擇鍵盤
            ...
            Toast.makeText(this, "選擇鍵盤控件初始化失敗：" + e.getMessage(),
                    Toast.LENGTH_LONG).show();
        }
        // 返回View对象
        return keyboardView;
    ...
    public void setComposingText(String code) {
        ...
        if (StringUtils.hasText(code)) {
            ...
            if (stat.isShouldTranslate()) {
                ...
                composing = cnstat.getComposingTextForCandidateView();
            }
    ...
    public void setInputMethodStatus(InputMethodStatus stat) {
        try {
            ...
            Toast.makeText(this, "切換輸入法種類失敗：" + e.getMessage(),
                    Toast.LENGTH_LONG).show();
        }
    }
