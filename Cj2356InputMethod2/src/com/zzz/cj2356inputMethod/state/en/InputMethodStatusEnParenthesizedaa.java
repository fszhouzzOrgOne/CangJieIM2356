...
public class InputMethodStatusEnParenthesizedaa extends InputMethodStatusEn {

    public static final String SUBTYPE_CODE = "⒜";
    public static final String SUBTYPE_NAME = "括號";

    public InputMethodStatusEnParenthesizedaa(Context con) {
        super(con);
