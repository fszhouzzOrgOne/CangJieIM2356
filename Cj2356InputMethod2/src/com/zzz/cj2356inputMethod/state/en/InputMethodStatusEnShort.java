...
public class InputMethodStatusEnShort extends InputMethodStatusEn {

    public static final String SUBTYPE_CODE = "ᴀᴀ";
    public static final String SUBTYPE_NAME = "小字";

    public InputMethodStatusEnShort(Context con) {
        super(con);
    ...
    public Map<String, Object> getKeysNameMap() {
        ...
        String letters2 = "ᴀʙᴄᴅᴇғɢʜɪᴊᴋʟᴍɴᴏᴘǫʀsᴛᴜᴠᴡxʏᴢ";
