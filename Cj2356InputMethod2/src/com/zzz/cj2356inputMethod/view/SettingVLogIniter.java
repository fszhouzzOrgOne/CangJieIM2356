    ...
    public static void initSettingVLog(Context con) {
        ...
        setTextview
                .setText("倉頡輸入法2356說明："
                        ...
                        + "\n    版本29.2.2.2，在29.2.2.1基礎上，字體更新，可以支持統一碼擴展F區了,以後考慮加入碼表。"
                        + "\n    版本29.2.2.3，在29.2.2.2基礎上，加了幾個字編碼，如田止。"
                        + "\n    版本30，30.1版本默認字體，30.2版本自定義字體，30.2.1純六代，30.2.2純六代加詞組。把倉頡字典整合進來，從桌面圖標進入。" 
                        );
    }
